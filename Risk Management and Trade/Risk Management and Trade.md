...
&\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space=\sum_{\tau=0}^{T-1}F(\lambda,\tau)R_{t-\tau}^{2}=ARCH(q)+ARCH_{G}(p=1),\space (s.t.\space \mu_{R_{t+1}}=0,\space\text{Includes current period})\\
