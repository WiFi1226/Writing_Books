...
&\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\xlongequal{\text{Expand to item p}}\sum_{\tau=0}^{q-1}F(\lambda,\tau)R_{t-\tau}^{2}+\sum_{q=1}^{p}\sum_{\tau=0}^{T-q-1}F(\lambda,\tau+q)\sigma_{t-q+1}^{2}\space(s.t.\space p+q\leq T)\\
&\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space=\sum_{\tau=0}^{q-1}\alpha_{\tau}R_{t-\tau}^{2}+\sum_{q=1}^{p}\beta_{r,q}\sigma_{t-q+1}^{2}\\
