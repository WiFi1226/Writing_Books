...
&\xlongequal{\text{TARCH(p,q)}}\frac{1}{q}\sum_{\tau=0}^{q-1}R_{t-\tau}^{2}=\sum_{\tau=0}^{q-1}\frac{1}{q}R_{t-\tau}^{2}\xlongequal{\text{wide sense}}\sum_{\tau=0}^{q-1}\alpha_{\tau}R_{t-\tau}^{2}=\sum_{\tau=0}^{q-1}F(\lambda,\tau)R_{t-\tau}^{2},\space(\text{Not includes constant})\\
\end{aligned}
$$
